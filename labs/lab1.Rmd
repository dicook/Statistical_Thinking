...
- Look at the document `economics` data in the `ggplot2` package. Can you think of two questions you could answer using these variables?
...
5. Write a few sentences explaining what you learn aboutreading in these two countries.
...
- DUE: One day after the lab, loaded into moodle
