...
In order to complete our task we'll need to learn some more programming techinques!
...
Let's go through execerise 1 of the tutorial. Remember to record your 
...
- an object of suffucient size to store the output of the loop. 
