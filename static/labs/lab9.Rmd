...
From previous examination of my mail I have learned that 70% of emails are spam, 2% of spam email have "free" in the subject line, and .1% of non-spam emails have this word in the subject line.
...
In the lecture we used a power law prior to dampen down the estimate of the number of locomotives. Instead fit a $U[\mu-10, \mu+10]$ prior. Instead fit a $N(\mu, 100)$ prior. Plot the posterior distributions. 
