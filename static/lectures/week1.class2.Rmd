...
- The payoff is the amount of money each player receive after choosing their respective strategies 
...
1. Fix your decision to be $a_1$
2. Randomly generate the opponents response
3. Count the number of times you win, lose, tie

```{r}
set.seed(106)
d <- sample(c("Rock", "Paper", "Scissors"), 100, replace=TRUE)
table(d)
```
...
Now what should be your strategy?
