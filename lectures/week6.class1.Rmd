---
title: 'Statistical Methods for Insurance: Bootstrap, Permutation and Linear Models'
...
kable(tidy(florida_lm))
```

## Predictors

```{r fig.width=10, fig.height=2}
p1 <- ggplot(florida, aes(x=`age 65 (%)`, y=Log_Buchanan, label=County)) + geom_point()
p2 <- ggplot(florida, aes(x=Black, y=Log_Buchanan, label=County)) + geom_point()
p3 <- ggplot(florida, aes(x=Hispanic, y=Log_Buchanan, label=County)) + geom_point()
p4 <- ggplot(florida, aes(x=college, y=Log_Buchanan, label=County)) + geom_point()
p5 <- ggplot(florida, aes(x=`Income (Thousands)`, y=Log_Buchanan, label=County)) + geom_point()
...
p1 <- ggplot(florida_augment, aes(x=.fitted, y=Log_Buchanan, label=County)) + geom_point()
p2 <- ggplot(florida_augment, aes(x=.fitted, y=.resid, label=County)) + geom_point()
grid.arrange(p1, p2, ncol=2)
```
