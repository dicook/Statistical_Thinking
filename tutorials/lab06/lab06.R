setwd("~/Teaching/Statistical_Thinking/tutorials/")
...
australia <- australia %>% 
  select(math, ST04Q01, ST06Q01, ST57Q02, ST15Q01, ST19Q01, ST26Q01, ST26Q02, 
...
australia <- australia %>% select(-ST57Q02) # drop ST57Q02
